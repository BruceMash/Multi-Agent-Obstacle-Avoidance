...
from baseline.common import utils
from baseline.common.callbacks import BaseCallback, CallbackList, ConvertCallback, ProgressBarCallback
from baseline.common.env_util import is_wrapped
from baseline.common.logger import Logger
from baseline.common.monitor import Monitor
from baseline.common.noise import ActionNoise
from baseline.common.policies import BasePolicy
from baseline.common.preprocessing import check_for_nested_spaces, is_image_space, is_image_space_channels_first
from baseline.common.save_util import load_from_zip_file, recursive_getattr, recursive_setattr, save_to_zip_file
from baseline.common.type_aliases import GymEnv, MaybeCallback, Schedule, TensorDict
from baseline.common.utils import (
    FloatSchedule,
...
from baseline.common.vec_env import (
    DummyVecEnv,
    VecEnv,
    VecNormalize,
    VecTransposeImage,
...
from baseline.common.vec_env.patch_gym import _convert_space, _patch_env
...
class BaseAlgorithm(ABC):
    ...
    def load(  # noqa: C901
        ...
        **kwargs,
        ...
        try:
            ...
            # Patch to load policies saved with an older checkpoint format.
            # The error is probably due to an old policy layout being loaded.
            # See https://github.com/DLR-RM/stable-baselines3/issues/1233
            if "pi_features_extractor" in str(e) and "Missing key(s) in state_dict" in str(e):
                model.set_parameters(params, exact_match=False, device=device)
                warnings.warn(
                    "You are probably loading an A2C/PPO model saved with an older checkpoint format, "
            ...
            # Patch to load DQN policies saved with an older checkpoint format.
            ...
            if n_params_saved == 2 * n_params:
                ...
                model.set_parameters(params, exact_match=True, device=device)
                warnings.warn(
                    "You are probably loading a DQN model saved with an older checkpoint format, "
    ...
    def _dump_logs(self, *args) -> None:
        warnings.warn("algo._dump_logs() is deprecated in favor of algo.dump_logs().")
        self.dump_logs(*args)
