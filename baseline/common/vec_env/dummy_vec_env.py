...
from baseline.common.vec_env.base_vec_env import VecEnv, VecEnvIndices, VecEnvObs, VecEnvStepReturn
from baseline.common.vec_env.patch_gym import _patch_env
from baseline.common.vec_env.util import dict_to_obs, obs_space_info
...
class DummyVecEnv(VecEnv):
    ...
    def step_wait(self) -> VecEnvStepReturn:
        ...
        for env_idx in range(self.num_envs):
            ...
            # convert to the baseline VecEnv API
    ...
    def env_is_wrapped(self, wrapper_class: type[gym.Wrapper], indices: VecEnvIndices = None) -> list[bool]:
        ...
        from baseline.common import env_util
