...
from baseline.common.base_class import BaseAlgorithm
from baseline.common.buffers import DictReplayBuffer, NStepReplayBuffer, ReplayBuffer
from baseline.common.callbacks import BaseCallback
from baseline.common.noise import ActionNoise, VectorizedActionNoise
from baseline.common.policies import BasePolicy
from baseline.common.save_util import load_from_pkl, save_to_pkl
from baseline.common.type_aliases import GymEnv, MaybeCallback, RolloutReturn, Schedule, TrainFreq, TrainFrequencyUnit
from baseline.common.utils import safe_mean, should_collect_more_steps
from baseline.common.vec_env import VecEnv
...
class OffPolicyAlgorithm(BaseAlgorithm):
    ...
    def _setup_model(self) -> None:
        ...
        if self.replay_buffer is None:
            # Use a local copy to avoid mutating externally provided replay buffer kwargs.
    ...
    def load_replay_buffer(
        ...
        # Older replay buffer archives may not store timeout termination separately.
