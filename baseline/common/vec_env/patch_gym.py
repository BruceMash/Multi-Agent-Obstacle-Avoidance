...
def _patch_env(env: Union["gym.Env", gymnasium.Env]) -> gymnasium.Env:  # pragma: no cover
    ...
    try:
        ...
        raise ImportError(
            ...
            "The current baseline uses Gymnasium internally. "
            "In order to use OpenAI Gym environments here, you need to "
    ...
    warnings.warn(
        ...
        "The current baseline is automatically wrapping your environments in a compatibility "
...
def _convert_space(space: Union["gym.Space", gymnasium.Space]) -> gymnasium.Space:  # pragma: no cover
    ...
    try:
        ...
        raise ImportError(
            ...
            "The current baseline uses Gymnasium internally. "
            "In order to use an OpenAI Gym space here, you need to "
