...
from baseline.common.vec_env.base_vec_env import VecEnv, VecEnvObs, VecEnvStepReturn, VecEnvWrapper
...
class VecMonitor(VecEnvWrapper):
    ...
    def __init__(
        ...
        from baseline.common.monitor import Monitor, ResultsWriter
