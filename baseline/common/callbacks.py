...
from baseline.common.evaluation import evaluate_policy
from baseline.common.vec_env import DummyVecEnv, VecEnv, sync_envs_normalization

if TYPE_CHECKING:
    from baseline.common import base_class
...
class ProgressBarCallback(BaseCallback):
    """
    Display a progress bar when training a baseline agent
